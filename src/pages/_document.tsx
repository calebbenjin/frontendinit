    ...
    <Html lang="en">
      <Head>
        ...
        />
          ...
          <meta itemProp="description" content="Join a fast growing frontend developer community, A community build for frontend developers to save you time and grow fast in your career." />
          <meta
            itemProp="image"
          ...
          <meta property="og:description" content="Join a fast growing frontend developer community, A community build for frontend developers to save you time and grow fast in your career." />
          <meta
            property="og:image"
            content="https://res.cloudinary.com/calebbenjin/image/upload/v1675421258/frontendinit_2_m8xgzx.png"
          />
